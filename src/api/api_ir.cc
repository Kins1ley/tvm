...
TVM_REGISTER_GLOBAL("make.Partition")
.set_body([](TVMArgs args,  TVMRetValue *ret) {
...
TVM_REGISTER_GLOBAL("make.Break")
.set_body([](TVMArgs args, TVMRetValue *ret) {
    *ret = Break::make();
  });

TVM_REGISTER_GLOBAL("make.Add")
.set_body([](TVMArgs args,  TVMRetValue *ret) {
...
TVM_REGISTER_GLOBAL("make.Select")
.set_body([](TVMArgs args,  TVMRetValue *ret) {
